...
CREATE SCHEMA `vbase` DEFAULT CHARACTER SET utf8mb4 ;
...
INSERT INTO `user` VALUES (1,'admin','$2a$10$PYY0nFKf85d9l.U.YPhcT.EdplicGWHgDauCs8vpx65sIEcOH2y1.',1,'2021 - 04 - 13 14:14:57','2021 - 04 - 13 14:14:57','3e80d1762a324d5b0ff636e0bd16f1e3');
...
CREATE TABLE `monitor_server` (
    ...
    `opsLink` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
