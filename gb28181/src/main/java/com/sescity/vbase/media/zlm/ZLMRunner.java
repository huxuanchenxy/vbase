...
import com.sescity.vbase.media.zlm.dto.HookSubscribeForServerStarted;
...
public class ZLMRunner implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        if (defaultMediaServer == null) {
            mediaServerService.addToDatabase(mediaConfig.getMediaSerItem(userSetting.getServerId()));
        }else {
            MediaServerItem mediaSerItem = mediaConfig.getMediaSerItem(userSetting.getServerId());
        ...
        if (all.size() == 0) {
            all.add(mediaConfig.getMediaSerItem(userSetting.getServerId()));
        }
    ...
    private ZLMServerConfig getMediaServerConfig(MediaServerItem mediaServerItem) {
