package com.sescity.vbase.common;

public class VideoManagerConstants {
	
	public static final String VBASE_SERVER_PREFIX = "VMP_SIGNALLING_SERVER_INFO_";

	public static final String VBASE_SERVER_STREAM_PREFIX = "VMP_SIGNALLING_STREAM_";
	 ...
	 * 流变化的通知
	 */
	public static final String VBASE_MSG_STREAM_CHANGE_PREFIX = "VBASE_MSG_STREAM_CHANGE_";
	...
	public static final String VBASE_STREAM_GB_ID_PREFIX = "memberNo_";
	public static final String VBASE_STREAM_GPS_MSG_PREFIX = "VBASE_STREAM_GPS_MSG_";
