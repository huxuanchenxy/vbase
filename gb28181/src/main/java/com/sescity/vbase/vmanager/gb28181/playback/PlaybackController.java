package com.sescity.vbase.vmanager.gb28181.playback;
...
public class PlaybackController {
	...
	public DeferredResult<VbaseResult<StreamInfo>> play(@PathVariable String deviceId, @PathVariable String channelId,
