...
import com.sescity.vbase.gb28181.transmit.callback.DeferredResultHolder;
...
import com.sescity.vbase.gb28181.transmit.cmd.impl.SIPCommanderForPlatform;
import com.sescity.vbase.media.zlm.dto.HookSubscribeFactory;
import com.sescity.vbase.media.zlm.dto.HookSubscribeForStreamChange;
import com.sescity.vbase.utils.DateUtil;
import com.sescity.vbase.media.zlm.AssistRESTfulUtils;
...
import com.sescity.vbase.service.IMediaService;
...
import com.sescity.vbase.service.bean.PlayBackResult;
...
public class PlayServiceImpl implements IPlayService {
    ...
    @Autowired
    private IRedisCacheStorage redisCacheStorage;
    ...
    public PlayResult play(MediaServerItem mediaServerItem, String deviceId, String channelId,
        ...
        DeferredResult<VbaseResult<StreamInfo>> result = new DeferredResult<>(userSetting.getPlayTimeout().longValue());
        playResult.setResult(result);
        // 录像查询以channelId作为deviceId查询
        resultHolder.put(key, uuid, result);

        Device device = redisCacheStorage.getDevice(deviceId);
        ...
        result.onCompletion(() -> {
            ...
            taskExecutor.execute(() -> {
                ...
                VbaseResult vbaseResult = (VbaseResult) result.getResult();
                if (Objects.requireNonNull(vbaseResult).getCode() == 0) {
                    StreamInfo streamInfoForSuccess = (StreamInfo) vbaseResult.getData();
        ...
        if (streamInfo != null) {
            ...
            if (streamId == null) {
                VbaseResult vbaseResult = new VbaseResult();
                vbaseResult.setCode(ErrorCode.ERROR100.getCode());
                vbaseResult.setMsg("点播失败， redis缓存streamId等于null");
                msg.setData(vbaseResult);
            ...
            if (rtpInfo.getInteger("code") == 0) {
                if (rtpInfo.getBoolean("exist")) {
                    ...
                    if (localPort == 0) {
                        ...
                        VbaseResult vbaseResult = new VbaseResult();
                        vbaseResult.setCode(ErrorCode.ERROR100.getCode());
                        vbaseResult.setMsg("点播已经在进行中，请稍候重试");
                        msg.setData(vbaseResult);
                        ...
                        VbaseResult vbaseResult = new VbaseResult();
                        vbaseResult.setCode(ErrorCode.SUCCESS.getCode());
                        vbaseResult.setMsg(ErrorCode.SUCCESS.getMsg());
                        vbaseResult.setData(streamInfo);
                        msg.setData(vbaseResult);
        ...
        if (streamInfo == null) {
            ...
            play(mediaServerItem, ssrcInfo, device, channelId, (mediaServerItemInUse, response) -> {
                ...
                VbaseResult vbaseResult = new VbaseResult();
                vbaseResult.setCode(ErrorCode.ERROR100.getCode());
                vbaseResult.setMsg(String.format("点播失败， 错误码： %s, %s", event.statusCode, event.msg));
                msg.setData(vbaseResult);
                resultHolder.invokeAllResult(msg);
                if (errorEvent != null) {
                ...
                vbaseResult.setCode(ErrorCode.ERROR100.getCode());
                if (code == 0) {
                    vbaseResult.setMsg("点播超时，请稍候重试");
                } else if (code == 1) {
                    vbaseResult.setMsg("收流超时，请稍候重试");
                }
                msg.setData(vbaseResult);
                // 回复之前所有的点播请求
                resultHolder.invokeAllResult(msg);
    ...
    public void play(MediaServerItem mediaServerItem, SSRCInfo ssrcInfo, Device device, String channelId,
        ...
        dynamicTask.startDelay(timeOutTaskKey, () -> {
            ...
            logger.info("[点播超时] 收流超时 deviceId: {}, channelId: {}，端口：{}, SSRC: {}, hostAddress: {}", device.getDeviceId(), channelId, finalSsrcInfo.getPort(), finalSsrcInfo.getSsrc(), device.getHostAddress());
            ...
            try {
                ...
                mediaServerService.closeRTPServer(mediaServerItem, finalSsrcInfo.getStream(), finalSsrcInfo.getSsrc());
    ...
    public void onPublishHandlerForPlay(MediaServerItem mediaServerItem, JSONObject response, String deviceId, String channelId, String uuid) {
        ...
        if (streamInfo != null) {
            ...
            redisCacheStorage.startPlay(streamInfo);
            ...
            msg.setData(VbaseResult.fail(ErrorCode.ERROR100.getCode(), "设备预览API调用失败！"));
            resultHolder.invokeAllResult(msg);
        }
    }
    ...
    public void playBack(MediaServerItem mediaServerItem, SSRCInfo ssrcInfo,
        ...
        dynamicTask.startDelay(playBackTimeOutTaskKey, () -> {
            ...
            try {
                ...
                mediaServerService.closeRTPServer(mediaServerItem, ssrcInfo.getStream(), ssrcInfo.getSsrc());
        ...
        InviteStreamCallback hookEvent = (InviteStreamInfo inviteStreamInfo) -> {
            ...
            redisCacheStorage.startPlayback(streamInfo, inviteStreamInfo.getCallId());
            playBackResult.setCode(ErrorCode.SUCCESS.getCode());
            playBackResult.setMsg(ErrorCode.SUCCESS.getMsg());
            playBackResult.setData(streamInfo);
                    ...
                    if (eventResult.type == SipSubscribe.EventResultType.response) {
                        ...
                        if (ssrcIndex >= 0) {
                            ...
                            if (!mediaServerItem.isRtpEnable() || device.isSsrcCheck()) {
                                ...
                                // 关闭rtp server
                                mediaServerService.closeRTPServer(mediaServerItem, ssrcInfo.getStream(), ssrcInResponse);
                                // 重新开启ssrc server
    ...
    public void download(MediaServerItem mediaServerItem, SSRCInfo ssrcInfo, String deviceId, String channelId, String startTime, String endTime, int downloadSpeed, InviteStreamCallback infoCallBack, PlayBackCallback hookCallBack) {
        ...
        VbaseResult<StreamInfo> vbaseResult = new VbaseResult<>();
        ...
        SipSubscribe.Event errorEvent = event -> {
            ...
            vbaseResult.setCode(ErrorCode.ERROR100.getCode());
            vbaseResult.setMsg(String.format("录像下载失败， 错误码： %s, %s", event.statusCode, event.msg));
        ...
        InviteStreamCallback hookEvent = (InviteStreamInfo inviteStreamInfo) -> {
            ...
            redisCacheStorage.startDownload(streamInfo, inviteStreamInfo.getCallId());
    ...
    public StreamInfo getDownLoadInfo(String deviceId, String channelId, String stream) {
        StreamInfo streamInfo = redisCacheStorage.queryDownload(deviceId, channelId, stream, null);
        if (streamInfo != null) {
            ...
            if (mediaServerItem.getRecordAssistPort() > 0) {
                ...
                if (jsonObject != null && jsonObject.getInteger("code") == 0) {
                    ...
                    if (duration == 0) {
                        ...
                        streamInfo.setProgress(process > 1 ? 1 : process);
                    }
                }
            }
        }
    ...
    public void zlmServerOffline(String mediaServerId) {
        // 处理正在向上推流的上级平台
        List<SendRtpItem> sendRtpItems = redisCacheStorage.querySendRTPServer(null);
        if (sendRtpItems.size() > 0) {
            for (SendRtpItem sendRtpItem : sendRtpItems) {
                if (sendRtpItem.getMediaServerId().equals(mediaServerId)) {
                    ParentPlatform platform = storager.queryParentPlatByServerGBId(sendRtpItem.getPlatformId());
                    try {
                        sipCommanderForPlatform.streamByeCmd(platform, sendRtpItem.getCallId());
...
//        }));
    ...
    public void pauseRtp(String streamId) throws ServiceException, InvalidArgumentException, ParseException, SipException {
        String key = redisCacheStorage.queryPlaybackForKey(null, null, streamId, null);
        StreamInfo streamInfo = redisCacheStorage.queryPlayback(null, null, streamId, null);
        if (null == streamInfo) {
