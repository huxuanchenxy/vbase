...
public class Device {
	...
	@Schema(description = "修正的wan地址")
	private String natHostAddress;
	...
	public String getNatHostAddress() {
		return natHostAddress;
	}

	public void setNatHostAddress(String natHostAddress) {
		this.natHostAddress = natHostAddress;
	}
