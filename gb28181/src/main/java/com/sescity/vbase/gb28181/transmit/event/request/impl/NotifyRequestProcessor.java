...
public class NotifyRequestProcessor extends SIPRequestProcessorParent implements InitializingBean, ISIPRequestProcessor {
	...
	public void process(RequestEvent evt) {
		...
		taskQueue.offer(new HandlerCacheData(evt, null, null));
	...
	public IRedisCacheStorage getRedisCatchStorage() {
		return redisCatchStorage;
	}

	public void setRedisCatchStorage(IRedisCacheStorage redisCatchStorage) {
