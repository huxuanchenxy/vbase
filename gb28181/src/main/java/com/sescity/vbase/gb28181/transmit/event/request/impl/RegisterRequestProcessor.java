...
import com.sescity.vbase.gb28181.bean.VbaseSipDate;
...
import com.sescity.vbase.gb28181.auth.DigestServerAuthenticationHelper;
...
public class RegisterRequestProcessor extends SIPRequestProcessorParent implements InitializingBean, ISIPRequestProcessor {
    ...
    public void process(RequestEvent evt) {
        try {
            ...
            // 使用自己修改的
            VbaseSipDate vbaseSipDate = new VbaseSipDate(Calendar.getInstance(Locale.ENGLISH).getTimeInMillis());
            dateHeader.setDate(vbaseSipDate);
