...
import com.sescity.vbase.gb28181.transmit.cmd.SIPRequestHeaderPlatformProvider;
...
public class SIPCommanderForPlatform implements ISIPCommanderForPlatform {
    ...
    private final Logger logger = LoggerFactory.getLogger(SIPCommanderForPlatform.class);
...
//                    catalogXml.append("<ParentID>" + parentPlatform.getDeviceGBId() + "/" + channel.getParentId() + "</ParentID>\r\n");
    ...
    public void deviceInfoResponse(ParentPlatform parentPlatform, String sn, String fromTag) throws SipException, InvalidArgumentException, ParseException {
        ...
        deviceInfoXml.append("<Manufacturer>sescity</Manufacturer>\r\n");
        deviceInfoXml.append("<Model>vbase</Model>\r\n");
        deviceInfoXml.append("<Firmware>1.0.0</Firmware>\r\n");
    ...
    public void streamByeCmd(ParentPlatform platform, SendRtpItem sendRtpItem) throws SipException, InvalidArgumentException, ParseException {
        ...
        if (mediaServerItem != null) {
            mediaServerService.closeRTPServer(mediaServerItem, sendRtpItem.getStreamId(), sendRtpItem.getSsrc());
        }
