...
public interface GbStreamMapper {
    ...
    @Select("<script> "+
            "select gt.gbId as channelId, gt.name, 'sescity' as manufacture,  st.status, gt.longitude, gt.latitude, pc.id as parentId," +
            "       '1' as registerWay, pc.civilCode, 'live' as model, 'sescity' as owner, '0' as parental,'0' as secrecy" +
            " from gb_stream gt " +
            " left join (" +
            "    select " +
