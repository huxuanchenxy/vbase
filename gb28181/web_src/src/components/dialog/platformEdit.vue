          ...
          <el-col :span="11">
            <el-form ref="platform1" :rules="rules" :model="platform" label-width="160px">
              ...
              <el-form-item label="SIP服务国标编码" prop="serverGBId">
                <el-input v-model="platform.serverGBId" clearable @input="serverGBIdChange" onkeyup="value=value.replace(/[^a-zA-Z0-9]/g,'')"  ></el-input>
              </el-form-item>
          ...
          <el-col :span="12">
            <el-form ref="platform2" :rules="rules" :model="platform" label-width="160px">
              ...
              <el-form-item label="注册周期(秒)" prop="expires">
                <el-input v-model="platform.expires" onkeyup="value=value.replace(/[^\d]/g,'')"></el-input>
              </el-form-item>
              <el-form-item label="心跳周期(秒)" prop="keepTimeout">
                <el-input v-model="platform.keepTimeout" onkeyup="value=value.replace(/[^\d]/g,'')"></el-input>
              </el-form-item>
