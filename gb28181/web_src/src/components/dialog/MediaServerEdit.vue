    ...
    checkServer: function() {
      ...
      that.mediaServer.checkServer(that.mediaServerForm, data =>{
        if (data.code === 0) {
          ...
          var ports = this.mediaServerForm.sendRtpPortRange.split(",");
          that.sendRtpPortRange1 = ports[0]
          that.sendRtpPortRange2 = ports[1]

          ports = this.mediaServerForm.rtpPortRange.split(",");
